...
PreparedStatement pst=null;
    ...
    private void Update_Employee(){
     try{
     String sql ="Select id, first_name, surname, Status from STAFF_INFORMATION";
     pst=conn.prepareStatement(sql);
     rs = pst.executeQuery();
     JTable_E.setModel(DbUtils.resultSetToTableModel(rs));
 }   
     catch(Exception e){
     ...
     private void searchemp(){
        ...
        try{
            ...
            rs= pst.executeQuery();
            while(rs.next()){
                jComboSelect.addItem(rs.getString("id"));
    ...
    private void initComponents() {
        ...
        JTable_E = new javax.swing.JTable();
        jLabel3 = new javax.swing.JLabel();
        Salpm = new javax.swing.JTextField();
        jLabel16 = new javax.swing.JLabel();
        txt_Ab = new javax.swing.JTextField();
        ...
        jLabel21.setText("Select Emp ID :");

        jComboSelect.addPopupMenuListener(new javax.swing.event.PopupMenuListener() {
            public void popupMenuCanceled(javax.swing.event.PopupMenuEvent evt) {
            }
            public void popupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {
                jComboSelectPopupMenuWillBecomeInvisible(evt);
            }
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addComponent(jComboSelect, javax.swing.GroupLayout.PREFERRED_SIZE, 79, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        JTable_E.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(JTable_E);

        jLabel3.setText("Salary PD :");

        Salpm.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SalpmActionPerformed(evt);
            }
        });

        jLabel16.setText("Total Adsence:");

        txt_Ab.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_AbActionPerformed(evt);
            }
        });
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                            ...
                                            .addComponent(txt_id)
                                            .addComponent(txt_dep, javax.swing.GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE)
                                            .addComponent(Salpm))
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(layout.createSequentialGroup()
                                                .addGap(53, 53, 53)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(jLabel16)
                                    .addComponent(txt_Ab, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(31, 31, 31)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(jLabel5)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(Salpm, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jLabel3))
                                .addGap(18, 18, 18)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(jLabel12)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       try{
        ...
        txt_reason.setText("Absence");
         }
        
        if(r_amount2.isSelected()== true){
        
        int S = Integer.parseInt(txt_salary.getText());
        int Salary = S/24;
        int ab = Integer.parseInt(txt_Ab.getText());
        int de = ab*Salary;
        txt_deduction.setText(String.valueOf(de));
        ...
        txt_reason.setText("Absence");
           ...
           JOptionPane.showMessageDialog(null, "Select Amount and Absence");
       }
    ...
    private void SalpmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SalpmActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_SalpmActionPerformed
    ...
    private void jComboSelectPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_jComboSelectPopupMenuWillBecomeInvisible
        // TODO add your handling code here:
        String tmp = (String)jComboSelect.getSelectedItem();
        try{
    ...
    }//GEN-LAST:event_jComboSelectPopupMenuWillBecomeInvisible

    private void txt_AbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_AbActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_AbActionPerformed
    ...
    private javax.swing.JTable JTable_E;
    private javax.swing.JTextField Salpm;
    ...
    private javax.swing.JTextField txt_Ab;
